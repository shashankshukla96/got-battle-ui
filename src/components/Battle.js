            ...
            <div className='card2'>
				...
				<div className="numbers">{battle.defender_size ? battle.defender_size : 0}</div>
                    ...
                    <div className='logo'>
                        <img
                            alt='right-front'
                            src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTj2rHz5GVNcn767nlpD_YJcXQZKlcDzDfIKg&usqp=CAU'
                        />
                    </div>
                </div>
            </div>
